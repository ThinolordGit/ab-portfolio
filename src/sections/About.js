    ...
    <section id="about">
      <div ref={refProp} className="xf-scale glass-card">
        <div className="fcol ai-center gap-4 w-100">
          ...
          <img src={usePublicUri("img/pp2.jpg")} alt="Amadou Aboubakar About" className='avatar about-avatar show-it-mobile' />
          <div className="w-100 d-flex gap-1 ai-end">
            ...
            <img src={usePublicUri("img/pp2.jpg")} alt="Amadou Aboubakar About" className='avatar about-avatar hide-it-mobile' />
          </div>
        </div>
      </div>
    </section>
